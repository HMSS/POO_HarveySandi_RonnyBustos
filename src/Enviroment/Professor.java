...
public class Professor extends Person {
	 ...
	 * @uml.property  name="schedule"
	 */
	public Schedule[] scheduleToArray() {
		return (Schedule[]) schedule.toArray(new Schedule[schedule.size()]);
	}
	 ...
	 * @uml.property  name="schedule"
	 */
	public Schedule[] scheduleToArray(Schedule[] schedule) {
		return (Schedule[]) this.schedule.toArray(schedule);
	}
